  ...
  reducers: {
    addToCart: (state, action) => {
      ...
      if (item) {
        ...
        // console.log("this data of action payload", state.cartItems);
      } else {
        state.cartItems.push({ ...action.payload, quantity: 1 });
        // console.log("this data of action payload", action.payload);
        // console.log("this is items data", state.cartItems);
      }
    },
