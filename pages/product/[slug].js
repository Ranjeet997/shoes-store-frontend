...
export default function ProductDetails({ product, products }) {
  ...
  const notify =()=>{
    toast.success('successfully add item. check your cart!', {
            ...
            <div className="flex-[1] py-3">
              ...
              <div className="mb-10">
                ...
                <div className="flex justify-between mb-2">
                  ...
                  <div className="textmd font-medium text-black/[0.5] cursor-pointer">
                    Select Guide
                  </div>
                </div>
                {/* HEADING END */}
              ...
              <button
                className="w-full py-4 rounded-full bg-black text-white text-center text-lg font-medium transition-transform active:scale-95 mb-3 hover:opacity-75"
              ...
              {/* ADD TO CART BUTTON START */}
              <button className="w-full py-4 rounded-full border border-black text-lg font-medium transition-transform active:scale-95 mb-10 hover:opacity-75 flex justify-center items-center">
                Whishlist
              ...
              <div className="">
                ...
                <div className="text-mb mb-5 markdown">
